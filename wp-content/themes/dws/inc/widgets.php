 ...
 */
add_filter( 'dynamic_sidebar_params', 'dws_widget_classes' );

if ( ! function_exists( 'dws_widget_classes' ) ) {
	/**
	 ...
	 * @return array $params
	 */
	function dws_widget_classes( $params ) {
...
} // endif function_exists( 'dws_widget_classes' ).

add_action( 'widgets_init', 'dws_widgets_init' );

if ( ! function_exists( 'dws_widgets_init' ) ) {
	/**
	 * Initializes themes widgets.
	 */
	function dws_widgets_init() {
		register_sidebar(
			array(
				'name'          => __( 'Right Sidebar', 'dws' ),
				'id'            => 'right-sidebar',
				'description'   => __( 'Right sidebar widget area', 'dws' ),
		...
		register_sidebar(
			array(
				'name'          => __( 'Left Sidebar', 'dws' ),
				'id'            => 'left-sidebar',
				'description'   => __( 'Left sidebar widget area', 'dws' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget'  => '</aside>',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',
		...
		register_sidebar(
			array(
				'name'          => __( 'Hero Slider', 'dws' ),
				'id'            => 'hero',
				'description'   => __( 'Hero slider area. Place two or more widgets here and they will slide!', 'dws' ),
		...
		register_sidebar(
			array(
				'name'          => __( 'Top Full', 'dws' ),
				'id'            => 'statichero',
				'description'   => __( 'Full top widget with dynamic grid', 'dws' ),
		...
		register_sidebar(
			array(
				'name'          => __( 'Footer Full', 'dws' ),
				'id'            => 'footerfull',
				'description'   => __( 'Full sized footer widget with dynamic grid', 'dws' ),
				'before_widget' => '<div id="%1$s" class="footer-widget %2$s dynamic-classes">',
...
} // endif function_exists( 'dws_widgets_init' ).
