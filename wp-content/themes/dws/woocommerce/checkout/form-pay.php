	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'dws' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'dws' ); ?></th>
			</tr>
		</thead>
		<tbody>
